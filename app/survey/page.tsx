...
export default function Survey(){
 ...
 return <main className="shell"><div className="surveyShell"><a href="/" className="brand">ONE <span>SCHENECTADY</span></a><div style={{height:18}}/>
   ...
   {step===1&&<><div className="eyebrow">Neighborhood</div><div className="question">Which neighborhood best describes your connection?</div><div className="options">{neighborhoods.map(n=><label className="option" key={n}><input type="radio" name="n" checked={data.neighborhood===n} onChange={()=>setData({...data,neighborhood:n})}/>{n}</label>)}</div></>}
